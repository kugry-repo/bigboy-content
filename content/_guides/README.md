...
This folder is the guide library for the Markdown authoring system.

Use the category folders to pick the smallest relevant guide set for the task.

## Taxonomy

- `core/` = global authoring behavior, learner product boundaries, style, source safety, Obsidian conventions, validation, and review checklists.
