...
| `exam-readiness` | Exam-pattern recognition, transfer, traps, and time pressure. | Supported exam-pattern tasks, explicit source-safety notes, and remediation links that already exist or can be sketched. |

Do not create an `exam-readiness` quiz before enough lessons, exercises, and remediation paths exist to make the result actionable.
...
| Remediation quality | No next step after diagnosis. | General advice such as "review the lesson." | Routes by mastery level and misconception to lessons, exercises, mini-reviews, or retry item types. |
...
Do not create exam-readiness quizzes before enough lessons, exercises, and remediation links exist.
