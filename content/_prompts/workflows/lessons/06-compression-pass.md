...
Use `content/_guides/lesson-voice.md` as the canonical voice standard. Do not duplicate the full guide in the lesson file.
...
- preferred lesson naming and heading conventions from `content/_guides/lesson-voice.md` and `content/_guides/lesson-structure.md`;
...
- optional 1-5 quality score using `content/_guides/lesson-quality-rubric.md` if the user requested scoring;
