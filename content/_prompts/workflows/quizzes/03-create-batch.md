...
This step outputs draft quiz files under `quizzes/`. These files still need `workflows/quizzes/04-review-quizzes.md` before their answer keys or feedback are treated as reviewed.
