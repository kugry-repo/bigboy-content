...
|---|---|---|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-ef-lesson-001 | `lessons/ef-lesson-001.md` | TODO | TODO | TODO | TODO | TODO | TODO | TODO | TODO | TODO |
...
TODO: ajouter des seeds bruts uniquement lorsqu'un cluster de méthode est demandé.

## Plan des exercices

| ID prévu | Fichier prévu | Cluster | Niveau | Type | Compétences | Objectif | Mini-leçon liée |
|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-ef-ex-001 | `exercises/ef-ex-001.md` | TODO | TODO | TODO | TODO | TODO | TODO |
...
|---|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-ef-quiz-001 | `quizzes/ef-quiz-001.md` | TODO | TODO | TODO | TODO | TODO | TODO | TODO |
...
TODO: prévoir des parcours méthode qui lient vers des contenus officiels existants lorsque c'est plus clair que de réécrire.
