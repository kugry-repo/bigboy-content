...
unit_code: rg
unit_slug: revision-globale
unit_folder: topics/revision-globale
unit_order: 1
official: false
...
|---|---|---|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-rg-lesson-001 | `lessons/rg-lesson-001.md` | TODO | TODO | TODO | TODO | TODO | TODO | TODO | TODO | TODO |
...
TODO: ajouter des seeds bruts uniquement lorsqu'un cluster de révision est demandé.

## Plan des exercices

| ID prévu | Fichier prévu | Cluster | Niveau | Type | Compétences | Objectif | Mini-leçon liée |
|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-rg-ex-001 | `exercises/rg-ex-001.md` | TODO | TODO | TODO | TODO | TODO | TODO |
...
|---|---|---|---|---|---|---|---|---|
| 2bac-pcsvt-rg-quiz-001 | `quizzes/rg-quiz-001.md` | TODO | TODO | TODO | TODO | TODO | TODO | TODO |
...
TODO: prévoir des parcours de révision qui lient vers des contenus existants au lieu de les dupliquer.
