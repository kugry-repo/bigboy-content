...
The canonical lifecycle guide is `content/_guides/unit-workflow.md`. Unit `_index.md` files are the only unit-planning artifacts, and rich exercise/quiz design cards are the source of truth for final file creation.
